...
#
#     ./work/benchmarks/run_sweep_500_turbo.sh
#
# Paths below are relative to work/, which line 16 cd's into. Corpora in ../IN/,
# output to ../OUT/results/ since the 2026-08-04 restructure -- see
# memory/RESTRUCTURE-2026-08-04.md.
#
...
#
# Writes a NEW jsonl rather than reusing ../OUT/results/socrata500.jsonl, because that
...
OUT=../OUT/results/socrata500-turbo.jsonl
rc=0
...
for who in polypress polypress-turbo; do
    nice -n 19 python3 benchmarks/report.py "$OUT" --ours "$who" \
        ...
        --csv "../OUT/results/socrata500-${who}-results.csv" \
        > "../OUT/results/socrata500-${who}-summary.txt" 2>&1
done
